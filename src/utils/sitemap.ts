...
import { texasCityAuthorityPages } from '../data/texasCityAuthority';
...
export function getIndexableUrls(): string[] {
  ...
  // Dynamic Texas city pages are generated by src/pages/texas/[city].astro.
  // Add them explicitly so the sitemap remains complete after removing the
  // previous one-file-per-city implementation.
  for (const city of texasCityAuthorityPages) {
    urls.push(`${SITE_URL}/texas/${city.slug}-solar-site-surveyors/`);
  }
